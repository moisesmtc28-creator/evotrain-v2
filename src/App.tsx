                ...
                <Card key={treino.id}>
                  ...
                  {perfil?.tipo === 'professor' && (
                    <div style={styles.panel}>
                      ...
                      <p>
                        Salve exercícios como modelos e reutilize nos treinos de
                        outros alunos. Aqui aparecem somente os exercícios
                        criados por este professor.
                      </p>
                      ...
                      <div style={styles.bibliotecaGrid}>
                        {exerciciosBiblioteca.map((modelo) => (
                          <div
                            key={modelo.id}
                            style={styles.exercicioBibliotecaCard}
                          >
                            ...
                            <button
                              style={styles.danger}
                              onClick={() =>
                                excluirExercicioBiblioteca(modelo.id)
                              }
                            >
                              Excluir modelo
                            </button>
